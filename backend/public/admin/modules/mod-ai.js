/* ═══ UI-модуль: AI-аналітика (3 сторінки групи "Аналітика та AI") ════════════
 * Реєструє сторінки aisales / aiquality / aireco через window.registerModule.
 * Дані тягне з:
 ...
 * Кожен loader у try/catch з modErr. Boot тут НЕ викликаємо.
 * ───────────────────────────────────────────────────────────────────────────── */
(function () {
  var esc = window.modEsc, empty = window.modEmpty, errEl = window.modErr, card = window.modCard;

  // ── дрібні хелпери форматування (усе з захистом від null/undefined) ──
  ...
  // конверсія приходить як частка (0..1) — показуємо у відсотках
  function ratePct(x) {
    if (x == null || isNaN(Number(x))) return '—';
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // 2) AI Контроль якості — /api/ai/quality
  // ════════════════════════════════════════════════════════════════════════════
  window.registerModule({
    page: 'aiquality',
    title: 'AI Контроль якості',
    group: 'analytics',
    icon: 'verified',
    section:
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // 3) AI Рекомендації — /api/ai/recommendations
  // ════════════════════════════════════════════════════════════════════════════
  window.registerModule({
    page: 'aireco',
