...
const GRANTABLE_PERMS = [
  ...
  { key: 'admin.read',        group: 'Налаштування', label: 'Адмін-панель (перегляд)' },
  { key: 'admin.write',       group: 'Налаштування', label: 'Адмін-панель (керування)' },
  { key: 'sync.write',        group: 'Налаштування', label: 'Синхронізація/міграція' },
  { key: 'novaposhta.write',  group: 'Налаштування', label: 'Нова Пошта (відправлення)' },
  { key: 'notify.write',      group: 'Налаштування', label: 'Сповіщення (налаштування)' },
  { key: 'file.read',         group: 'Файли',     label: 'Дивитись файли' },
  { key: 'file.write',        group: 'Файли',     label: 'Завантажувати/видаляти файли' },
  { key: 'search.read',       group: 'Файли',     label: 'Глобальний пошук' },
  { key: 'reminders.manage',  group: 'Робота салону', label: 'Нагадування (керування)' },
  // Постачальники
  { key: 'supplier.read',        group: 'Постачальники', label: 'Дивитись постачальників' },
  { key: 'supplier.write',       group: 'Постачальники', label: 'Редагувати постачальників' },
  { key: 'supplier.delete',      group: 'Постачальники', label: 'Видаляти постачальників' },
  { key: 'supplier.prices.read', group: 'Постачальники', label: 'Прайси постачальників' },
  { key: 'supplier.docs.write',  group: 'Постачальники', label: 'Документи постачальників' },
  { key: 'supplier.rate',        group: 'Постачальники', label: 'Оцінювати постачальників' },
  // P&L / Фінанси (детально)
  { key: 'pnl.read',          group: 'Гроші та звіти', label: 'P&L (перегляд)' },
  { key: 'pnl.generate',      group: 'Гроші та звіти', label: 'P&L (формувати)' },
  { key: 'pnl.drilldown',     group: 'Гроші та звіти', label: 'P&L (деталізація)' },
  { key: 'pnl.margins.read',  group: 'Гроші та звіти', label: 'P&L (маржа)' },
  { key: 'pnl.export',        group: 'Гроші та звіти', label: 'P&L (експорт)' },
  { key: 'pnl.config.manage', group: 'Гроші та звіти', label: 'P&L (налаштування)' },
  // Комунікації — Дзвінки
  { key: 'calls.dial',              group: 'Дзвінки', label: 'Телефонувати' },
  { key: 'calls.log.read',          group: 'Дзвінки', label: 'Історія дзвінків' },
  { key: 'calls.live.read',         group: 'Дзвінки', label: 'Дзвінки наживо' },
  { key: 'calls.recordings.listen', group: 'Дзвінки', label: 'Слухати записи' },
  { key: 'calls.callback.read',     group: 'Дзвінки', label: 'Зворотні дзвінки (перегляд)' },
  { key: 'calls.callback.write',    group: 'Дзвінки', label: 'Зворотні дзвінки (керування)' },
  { key: 'calls.ivr.write',         group: 'Дзвінки', label: 'IVR/меню дзвінків' },
  { key: 'calls.blacklist.write',   group: 'Дзвінки', label: 'Чорний список дзвінків' },
  { key: 'calls.analytics.read',    group: 'Дзвінки', label: 'Аналітика дзвінків' },
  { key: 'calls.providers.read',    group: 'Дзвінки', label: 'Провайдери (перегляд)' },
  { key: 'calls.providers.write',   group: 'Дзвінки', label: 'Провайдери (керування)' },
  // Комунікації — Viber
  { key: 'viber.messages.read',      group: 'Viber', label: 'Повідомлення (перегляд)' },
  { key: 'viber.messages.send',      group: 'Viber', label: 'Надсилати повідомлення' },
  { key: 'viber.broadcasts.create',  group: 'Viber', label: 'Створювати розсилки' },
  { key: 'viber.broadcasts.execute', group: 'Viber', label: 'Запускати розсилки' },
  { key: 'viber.subscribers.read',   group: 'Viber', label: 'Підписники (перегляд)' },
  { key: 'viber.subscribers.write',  group: 'Viber', label: 'Підписники (керування)' },
  { key: 'viber.bot.write',          group: 'Viber', label: 'Бот (налаштування)' },
  { key: 'viber.config.read',        group: 'Viber', label: 'Налаштування (перегляд)' },
  { key: 'viber.config.write',       group: 'Viber', label: 'Налаштування (зміна)' },
  { key: 'viber.analytics.read',     group: 'Viber', label: 'Аналітика Viber' },
  { key: 'viber.cost.read',          group: 'Viber', label: 'Витрати на Viber' },
  // Аналітика та дані
  { key: 'dwh.read',          group: 'Аналітика', label: 'Сховище даних (перегляд)' },
  { key: 'dwh.query.execute', group: 'Аналітика', label: 'Виконувати запити DWH' },
  { key: 'dwh.manage',        group: 'Аналітика', label: 'Керувати сховищем даних' },
  { key: 'kpi_branches.read', group: 'Аналітика', label: 'KPI філій (перегляд)' },
  { key: 'kpi_branches.manage',group:'Аналітика', label: 'KPI філій (керування)' },
  { key: 'gbp.read',          group: 'Аналітика', label: 'Google Business (перегляд)' },
  { key: 'gbp.manage',        group: 'Аналітика', label: 'Google Business (керування)' },
  { key: 'marketplace.read',  group: 'Аналітика', label: 'Маркетплейс модулів (перегляд)' },
  { key: 'marketplace.manage',group: 'Аналітика', label: 'Маркетплейс модулів (керування)' },
  { key: 'backup.read',       group: 'Аналітика', label: 'Резервні копії (перегляд)' },
  { key: 'backup.manage',     group: 'Аналітика', label: 'Резервні копії (керування)' },
  // Платформа (SaaS — власнику платформи)
  { key: 'saas.read',         group: 'Платформа', label: 'SaaS-панель (перегляд)' },
  { key: 'saas.write',        group: 'Платформа', label: 'SaaS-панель (керування)' },
  { key: 'licenses.read',     group: 'Платформа', label: 'Ліцензії/модулі (перегляд)' },
  { key: 'licenses.manage',   group: 'Платформа', label: 'Ліцензії/модулі (керування)' },
];
