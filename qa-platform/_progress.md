...
## Этапы
1. staging.js — поднять backend на sandbox-ветке, health-check  ← ТЕКУЩИЙ
2. fix-worker.js — worktree + askClaude фикс + syntax-check
3. verify — QA-прогон против staging, вердикт
4. promote — merge+deploy при зелёном, откат при красном
